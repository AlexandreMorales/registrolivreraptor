...
<body>
	...
	<img id="elRaptor" src="assets/images/raptor.png" style="display: none; position: fixed; bottom: -300px; right: 0px;">
	<script src="http://code.jquery.com/jquery-2.1.1.min.js"></script>
	<script src="/assets/js/jquery.mask.min.js"></script>
	<script src="/assets/js/jquery.raptorize.2.0.js" type="text/javascript"></script>
