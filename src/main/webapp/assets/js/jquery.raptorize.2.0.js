...
(function($) {
  ...
  $.fn.raptorize = function(options) {
    ...
    return this.each(function() {
		...
		//var raptorAudioMarkup = '<audio id="elRaptorShriek" preload="auto"><source src="assets/sounds/raptor-sound.mp3" /><source src="sounds/raptor-sound.ogg" /></audio>';
		var locked = false;
...
//			}
		...
		if(options.enterOn == 'timer') {
            ...
            var kkeys = [], konami = "70,65,90,32,83,69,78,84,73,68,79,32,80,69,83,83,79,65,76";
